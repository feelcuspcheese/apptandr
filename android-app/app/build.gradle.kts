...
android {
    ...
    // Completely remove splits configuration for debug builds
    // When splits is configured (even disabled), it can interfere with APK generation
    // The universal APK will be generated by default without splits
